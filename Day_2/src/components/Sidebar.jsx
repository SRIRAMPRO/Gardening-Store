    ...
    <Drawer anchor="left" open={true} variant="persistent">
      <List>
        ...
        <ListItem button>
          ...
          <ListItemText primary="Plants" disableTypography />
        </ListItem>
        <ListItem button>
          <ListItemIcon style={{ color: '#009688', ...iconStyle }}>
            <AssignmentIcon />
          </ListItemIcon>
          <ListItemText primary="My Orders" disableTypography />
        </ListItem>
        <ListItem button>
          <ListItemIcon style={{ color: '#009688', ...iconStyle }}>
            <ShoppingBasketIcon />
          </ListItemIcon>
          <ListItemText primary="Basket" disableTypography />
        </ListItem>
        <ListItem button>
          <ListItemIcon style={{ color: '#009688', ...iconStyle }}>
            <GrassIcon />
          </ListItemIcon>
          <ListItemText primary="Plant Varieties" disableTypography />
        </ListItem>
        <ListItem button>
          <ListItemIcon style={{ color: '#009688', ...iconStyle }}>
            <PersonAddIcon />
      ...
      <List sx={{ marginTop: 10 }}>
        ...
        <ListItemButton>
          <ListItemIcon>
            <ExitToAppIcon style={{ color: '#f44336' }} /> {/* Add color to the ExitToAppIcon */}
          </ListItemIcon>
